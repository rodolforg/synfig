...
ToggleDucksDial::ToggleDucksDial(const std::string& action_prefix)
{
	...
	if (ActionWidgetHelper::create_action_button(action_position_duck)) {
		ActionWidgetHelper::init_toolbutton(ducks_position, action_position_duck);
		ActionWidgetHelper::init_toolbutton(ducks_vertex,   action_vertex_duck);
		ActionWidgetHelper::init_toolbutton(ducks_tangent,  action_tangent_duck);
		ActionWidgetHelper::init_toolbutton(ducks_radius,   action_radius_duck);
		ActionWidgetHelper::init_toolbutton(ducks_width,    action_width_duck);
		ActionWidgetHelper::init_toolbutton(ducks_angle,    action_angle_duck);
	} else {
