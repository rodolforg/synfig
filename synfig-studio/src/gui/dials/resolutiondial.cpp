...
ResolutionDial::ResolutionDial(const std::string& action_prefix)
{
	...
	if (ActionWidgetHelper::create_action_button(action_increase_resolution)) {
		ActionWidgetHelper::init_toolbutton(increase_resolution, action_increase_resolution);
		ActionWidgetHelper::init_toolbutton(decrease_resolution, action_decrease_resolution);
