...
CanvasView::register_doc_actions()
{
	...
	static const std::vector<ActionMetadata> action_list = {
		...
		{"decrease-low-res-pixel-size", "", "<Primary>parenleft",  N_("Increase Resolution"), N_("Increase Display Resolution") },
		{"increase-low-res-pixel-size", "", "<Primary>parenright", N_("Decrease Resolution"), N_("Decrease Display Resolution") },
	...
	static const std::vector<BoolActionMetadata> bool_action_list = {
		...
		{"toggle-low-res",              "",                          "<Primary>grave", N_("Use Low-Res"),             N_("Use Low Resolution when enabled") },
