...
private:
	...
	sigc::signal<void,synfig::Layer::Handle,bool> signal_layer_locked_changed_;
...
public:	// Signal Interface
	...
	//! Signal called when the layer's selection lock status has changed.
	sigc::signal<void,synfig::Layer::Handle,bool>& signal_layer_locked_changed() { return signal_layer_locked_changed_; }
